...
const Home = () => {
    return (
        <div name="home"
            className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 pt-60'>
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
                <div className='flex flex-col justify-center h-full'>
                    <h2 className=' text-4xl sm:text-7xl font-bold text-white'>I am a Mern stack Developer</h2>
                    <p className=' text-gray-300 py-4  max-w-md'>I have 8 year of experience buliding and designing a software
                        Currently , i am wroking on web technology using react Js node js
                        mongo db express  and tailwind css
                    </p>
                    <div>
